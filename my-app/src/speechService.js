export class SpeechService {
  speech = async (word, language) => {
    const response = await fetch('https://texttospeech.googleapis.com/v1beta1/text:synthesize?key=AIzaSyAexbAa5B0tvlfeYGs3aI2tr0O6WuXI1zA', {
      method: 'POST',
      body: JSON.stringify({
        input: {
          text: word,
